...
final class CategoryViewController: UIViewController {
    ...
    private let itemTypeCollectionView = ItemTypeCollectionView()
    ...
    func bind(_ viewModel: CategoryViewModel) {
        ...
        self.itemTypeCollectionView.bind(viewModel.itemTypeCollectionViewModel)
    ...
    private func layout() {
        [searchBarView, separator, eventCategoryListView, categoryListView, itemTypeCollectionView].forEach { view.addSubview($0) }
        ...
        itemTypeCollectionView.snp.makeConstraints {
            $0.top.equalTo(categoryListView.snp.top)
